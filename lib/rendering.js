...
function initScene(self, canvas, opts) {
    ...
    if(!this.vrMode) {
        ...
        self._camera = new BABYLON.WebVRFreeCamera("camera", new BABYLON.Vector3(0, this.vrOffset, 0), scene, true, { trackPosition: this.vrTracking });
        self._camera.deviceScaleFactor = this.vrScaleFactor;
    }
